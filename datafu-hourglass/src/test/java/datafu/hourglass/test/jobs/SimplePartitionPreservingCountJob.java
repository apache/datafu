...
import datafu.hourglass.test.jobs.counting.PartitionPreservingIncrementalCountJob;

public class SimplePartitionPreservingCountJob extends PartitionPreservingIncrementalCountJob
{  
  public static final Schema KEY_SCHEMA;
  
  static
  {
    KEY_SCHEMA = Schemas.createKeyRecordSchema(SimplePartitionPreservingCountJob.class,
  ...
  public SimplePartitionPreservingCountJob(String name, Properties props) throws IOException
  {
    super(name, props);
  }
