...
public class ImpressionClickPartitionPreservingJob extends AbstractPartitionPreservingIncrementalJob
{
  ...
  static
  {
    KEY_SCHEMA = Schemas.createRecordSchema(ImpressionClickPartitionPreservingJob.class, "Key",
                                            new Field("id", Schema.create(Type.LONG), null, null));
    
    INCREMENTAL_VALUE_SCHEMA = Schemas.createRecordSchema(ImpressionClickPartitionPreservingJob.class, "Value",
                                              new Field("type", Schema.createEnum("Value", null, "datafu.hourglass.test.jobs", Arrays.asList("click","impression")), null, null));
    
    OUTPUT_VALUE_SCHEMA = Schemas.createRecordSchema(ImpressionClickPartitionPreservingJob.class, "OutputValue",
                                            new Field("clicks", Schema.create(Type.INT), null, null),
                                            new Field("impressions", Schema.create(Type.INT), null, null));
  }
  
  public ImpressionClickPartitionPreservingJob(String name, Properties props) throws IOException
  {
    super(name, props);
  }
